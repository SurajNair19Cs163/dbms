...
< (select min(price) from flights where coming = 'Bangalore' and going = 'Frankfurt');
...
select aid from aircraft where cruisingrange > (select distance from flights where coming = 'Bangalore' 
and going = 'Delhi');
